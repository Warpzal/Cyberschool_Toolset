...
const createCyberschoolPortal = async (title) => {
  const createPortal = async () => {
    ...
    // Click Portal
    await page.click(
      ".quickadd-menu > ul:nth-child(2) > li:nth-child(2) > a:nth-child(1)"
    );
    //  Portal Title input
    await page.waitForSelector("#quickAddTitle");
    await page.type("#quickAddTitle", title);
    // Button: Create Portal
    await page.click("#input.btn-primary:nth-child(1)");
  };
};
